...
echo root:' ' | chpasswd
pacman -S --noconfirm xorg plasma dolphin kate kdialog keditbookmarks kfind khelpcenter kwrite ark gwenview grub nano git wget konsole networkmanager sddm os-prober ntfs-3g noto-fonts-cjk bluez bluez-utils pulseaudio-bluetooth sudo
